...
function FetchBlockDataFromSanity(courseCode, lessonName, setBlockData) {
  console.log("courseCode", courseCode, "lessonName", lessonName);

  useEffect(() => {
    sanityClient
      .fetch(
        `*[_type == "${courseCode}" && lessonName == "${lessonName}" ]
            {  subtopics[]-> {topicName}, topics[]->{topicName},   subject[]->,  subject_skills[]->, labelling, 
